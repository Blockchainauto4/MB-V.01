...
const TEXTS: Record<Language, {
  ...
  en: {
    ...
    hqDesc: "Save your Gemini API key to generate high-quality final images (Gemini 3 Pro). Your key is stored securely in your browser.",
    ...
    adminNote: "Admin Tip: To enable this feature for ALL users (Service Mode), add 'API_KEY' to your Vercel Environment Variables.",
  },
  pt: {
    ...
    hqDesc: "Salve sua chave de API Gemini para gerar imagens finais de alta qualidade (Gemini 3 Pro). Sua chave é armazenada com segurança no seu navegador.",
    ...
    adminNote: "Dica Admin: Para ativar este recurso para TODOS (Modo Serviço), adicione 'API_KEY' nas Variáveis de Ambiente do Vercel.",
  },
  es: {
    ...
    hqDesc: "Guarda tu clave API de Gemini para generar imágenes finales de alta calidad (Gemini 3 Pro). Tu clave se almacena de forma segura en tu navegador.",
    apiKeyPlaceholder: "Introduce tu clave API Gemini...",
    ...
    adminNote: "Tip Admin: Para activar esto para TODOS (Modo Servicio), añade 'API_KEY' a tus Variables de Entorno en Vercel.",
  },
  de: {
    ...
    hqDesc: "Speichern Sie Ihren Gemini API-Schlüssel, um hochwertige endgültige Bilder zu generieren (Gemini 3 Pro).",
    ...
    adminNote: "Admin-Tipp: Um dies für ALLE Benutzer zu aktivieren, fügen Sie 'API_KEY' in Vercel hinzu.",
  },
  fr: {
    ...
    hqDesc: "Enregistrez votre clé API Gemini pour générer des images finales de haute qualité (Gemini 3 Pro).",
    ...
    adminNote: "Astuce Admin : Pour activer pour TOUS, ajoutez 'API_KEY' dans Vercel.",
  },
  it: {
    ...
    hqDesc: "Salva la tua chiave API Gemini per generare immagini finali di alta qualità (Gemini 3 Pro).",
    ...
    adminNote: "Suggerimento Admin: Per abilitare per TUTTI, aggiungi 'API_KEY' su Vercel.",
  }
};
...
export const TechnicalGuides: React.FC<TechnicalGuidesProps> = ({ language, onNavigate }) => {
    ...
    const handleSaveKey = () => {
        ...
        logger.success('auth', 'User updated HQ API Key manually.');
